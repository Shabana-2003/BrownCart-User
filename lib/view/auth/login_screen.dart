...
import 'package:browncart_user/view/utils/constants/style/text_style.dart';
import 'package:flutter/material.dart';
import 'package:browncart_user/view/bottom_nav_bar/bottom_nav_bar.dart'; // Import the BottomNavBar
        ...
        listener: (context, state) {
          if (state is AuthLoading) {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => const BottomNavBar()), // Navigate to the BottomNavBar on success
            );
          } else if (state is AuthFailure) {
            setState(() {
              isLoading = false;
